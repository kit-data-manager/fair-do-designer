...
> [!note]
>
> Profiles are defined in external registries,
> which contain additional helpful information.
> For the builtin profiles, this information is linked here:
>
> - [HelmholtzKIP](https://hdl.handle.net/21.T11148/b9b76f887845e32d29f7)

<DemoWorkspace className="h-[11lh]" blocks={[
...
While profiles are sets of attributes,
an additional attribute is a single attribute you can add.
This may be in addition to other profiles or other attributes.
Otherwise, the concept is the same as for profiles.
