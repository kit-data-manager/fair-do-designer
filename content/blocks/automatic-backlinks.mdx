...
Blocks in this category are used to automatically create links between related FAIR DOs.
...
> [!important]
>
> See the [Connecting FAIR DOs Guide](/docs/connecting-fair-dos) to understand the concept of inverse references.
