...
![Definition of the terms forward-link and back-link](../img/blocks/connecting-fair-dos/term-reference-inverse.drawio.png)
...
![](../img/blocks/connecting-fair-dos/use.drawio.png)
