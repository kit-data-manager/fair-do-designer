...
![Overview of the workflow](./img/getting-started/overview.drawio.svg)
...
Undo and Redo functionality is also available using
<kbd>CTRL</kbd>+<kbd>Z</kbd>
and <kbd>CTRL</kbd>+<kbd>Shift</kbd>+<kbd>Z</kbd>,
where <kbd>CTRL</kbd> may need to be replaced
with <kbd>CMD</kbd>
or <kbd>ALT</kbd>,
depending on your system.

We recommend reading further in this guide.
In case you like to experiment with existing examples in parallel,
consider this list:

1. [open "Basic design example" in the FAIR DO Designer](https://kit-data-manager.github.io/fair-do-designer?remoteDesignImport=https://raw.githubusercontent.com/kit-data-manager/fair-do-designer/refs/heads/main/examples/basic.json)
2. (more examples are planned)
...
> you can add such information as a string block
> and provide it to your record:
>
