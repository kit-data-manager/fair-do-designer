...
> **Note**
>
> Only well-connected blocks are considered. Other blocks may be visibly ignored until properly connected:
> ![In this image, the upper block will be considered, the one at the bottom will currently be ignored.](./img/getting-started/ignored-blocks.png)
> In this image, the upper block will be considered, the one at the bottom will currently be ignored.
